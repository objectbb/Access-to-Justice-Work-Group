(function() {
    angular.module('taxidriver').controller('MapController', ['$scope', 'ReportService', '$q', '$animate',
        function($scope, ReportService, $q, $animate) {
            ...
            var changefiltertext = function(id, text) {

                if (text == "...")
                    $('#' + id).removeClass("animated infinite fadeIn");
                else
                 $('#' + id).addClass("animated infinite fadeIn");
            ...
            var refreshMap = function(url, dataurl, setmap) {
                ...
                then(function(data) {
                    ...
                    $q(function(resolve, reject) {
                        ...
                        .then(changefiltertext("filterstate", "Rendering Map..."))
                        .then(function(data) {
                            $scope.markers = data;
                        ...
                        .finally(changefiltertext("filterstate", "..."));
